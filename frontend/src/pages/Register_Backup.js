    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Join FixPoint</h1>
          <p className="text-lg text-gray-600 mb-4">
            Help build a better community by reporting and resolving civic issues
          </p>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4 text-center">Choose Your Registration Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <div className="flex flex-col items-center text-center">
                <UserIcon className={`h-8 w-8 mb-3 ${
                  registrationType === 'citizen' ? 'text-blue-600' : 'text-gray-400'
                }`} />
                <h3 className="text-lg font-medium text-gray-900 mb-2">Citizen</h3>
                <p className="text-sm text-gray-600 mb-3">
                  Report civic issues in your community and track their resolution
                </p>
                <div className="text-xs text-gray-500">
                  ✓ Submit reports with photos & location<br/>
                  ✓ Track issue status<br/>
                  ✓ Vote on community issues<br/>
            ...
            >
              <div className="flex flex-col items-center text-center">
                <UserGroupIcon className={`h-8 w-8 mb-3 ${
                  registrationType === 'organization_staff' ? 'text-green-600' : 'text-gray-400'
                }`} />
                <h3 className="text-lg font-medium text-gray-900 mb-2">Organization Staff</h3>
                <p className="text-sm text-gray-600 mb-3">
                  Join an existing organization to help resolve community issues
                </p>
                <div className="text-xs text-gray-500">
                  ✓ Manage assigned reports<br/>
            ...
            >
              <div className="flex flex-col items-center text-center">
                <BuildingOfficeIcon className={`h-8 w-8 mb-3 ${
                  registrationType === 'organization' ? 'text-purple-600' : 'text-gray-400'
                }`} />
                <h3 className="text-lg font-medium text-gray-900 mb-2">New Organization</h3>
                <p className="text-sm text-gray-600 mb-3">
                  Register your organization to receive and handle civic reports
                </p>
                <div className="text-xs text-gray-500">
                  ✓ Complete organization setup<br/>
                  ✓ Receive targeted reports<br/>
                  ✓ Manage organization staff<br/>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4">
            <h2 className="text-xl font-semibold text-white">
              ...
              {registrationType === 'organization_staff' && '👥 Staff Registration'}
              {registrationType === 'organization' && '🏢 Organization Registration'}
            </h2>
            <p className="text-blue-100 text-sm mt-1">
              {registrationType === 'citizen' && 'Create your citizen account to start reporting issues'}
              {registrationType === 'organization_staff' && 'Join an existing organization as staff member'}
              {registrationType === 'organization' && 'Register your organization and create admin account'}
            </p>
          </div>
          ...
          <div className="p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-200">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          {...register('organizationName', {
                            required: registrationType === 'organization' ? 'Organization name is required' : false
                          })}
                        />
                      ...
                      <div>
                        ...
                        <select
                          ...
                          {...register('organizationType', {
                            required: registrationType === 'organization' ? 'Organization type is required' : false
                          })}
                        >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          {...register('organizationEmail', {
                            required: registrationType === 'organization' ? 'Contact email is required' : false,
                            pattern: {
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <label htmlFor="organizationCity" className="block text-sm font-medium text-gray-700 mb-1">
                          City
                        </label>
                        <input
                          id="organizationCity"
              ...
              <div className={`rounded-lg p-6 border ${
                registrationType === 'citizen' ? 'bg-gradient-to-r from-blue-50 to-cyan-50 border-blue-200' :
                registrationType === 'organization_staff' ? 'bg-gradient-to-r from-green-50 to-emerald-50 border-green-200' :
                'bg-gradient-to-r from-indigo-50 to-blue-50 border-indigo-200'
              }`}>
                <div className="flex items-center mb-4">
                  <UserIcon className={`h-6 w-6 mr-2 ${
                    registrationType === 'citizen' ? 'text-blue-600' :
                    registrationType === 'organization_staff' ? 'text-green-600' :
                    'text-indigo-600'
                  }`} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 transition-colors ${
                          registrationType === 'citizen' ? 'focus:ring-blue-500 focus:border-blue-500' :
                          registrationType === 'organization_staff' ? 'focus:ring-green-500 focus:border-green-500' :
                  ...
                  <div className="space-y-4">
                    ...
                    {(registrationType === 'organization' || registrationType === 'organization_staff') && (
                      <div className="space-y-4">
                        <div>
                  ...
                  <div className="mt-6 p-4 bg-green-100 rounded-lg border border-green-200">
                    ...
                    <select
                      ...
                      {...register('organizationId', {
                        required: registrationType === 'organization_staff' ? 'Please select an organization' : false
                      })}
                    >
                      <option value="">Choose the organization you work for</option>
                    ...
                    <p className="mt-2 text-xs text-green-700">
                      Don't see your organization? Contact your admin or ask them to register the organization first.
                    </p>
                  </div>
                )}
              </div>
                ...
                <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-6 border border-amber-200">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="isVolunteer" className="ml-2 block text-sm font-medium text-gray-700">
                    ...
                    <div>
                      <label htmlFor="volunteerSkills" className="block text-sm font-medium text-gray-700 mb-1">
                        Skills & Expertise
                        <span className="text-xs text-gray-500 ml-1">(if volunteering)</span>
                      </label>
                      <textarea
                        id="volunteerSkills"
                        rows="3"
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Help us match you with relevant volunteer opportunities in your community.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="pt-6">
                ...
                >
                  {loading ? (
                    ...
                    <span>
                      {registrationType === 'organization' ? '🏢 Register Organization' : 
                       registrationType === 'organization_staff' ? '👥 Join as Staff Member' : 
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">For Government Offices</h3>
            <p className="text-sm text-gray-600">Register your office to receive and manage citizen reports efficiently.</p>
          </div>
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
            <div className="text-2xl mb-2">🏢</div>
            <h3 className="font-semibold text-gray-900 mb-1">For NGOs & Organizations</h3>
            <p className="text-sm text-gray-600">Connect with communities and help resolve local issues.</p>
          </div>
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
            <div className="text-2xl mb-2">👥</div>
            <h3 className="font-semibold text-gray-900 mb-1">For Citizens</h3>
            <p className="text-sm text-gray-600">Report issues, track progress, and make your community better.</p>
          </div>
        </div>
      </div>
    </div>
