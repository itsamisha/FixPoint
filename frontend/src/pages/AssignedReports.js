        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <span className="stat-number">
              {assignedReports.filter(r => r.status === 'UNDER_REVIEW' || r.status === 'IN_PROGRESS').length}
            </span>
        ...
        <div className="empty-state">
          ...
          <p>
            {statusFilter === 'ALL' 
              ...
              : `No reports with status "${statusOptions.find(opt => opt.value === statusFilter)?.label}" found.`
            }
          </p>
        </div>
      )}
