...
import VolunteerNotification from "../../components/Volunteers/VolunteerNotification";
import AIDescriptionGenerator from "../../components/AIComponents/AIDescriptionGenerator";
import EnhancedAIDescriptionGenerator from "../../components/EnhancedAIDescriptionGenerator/EnhancedAIDescriptionGenerator";
import SimpleAIDescriptionGenerator from "../../components/SimpleAIDescriptionGenerator/SimpleAIDescriptionGenerator";
import "../../components/SimpleAIDescriptionGenerator/SimpleAIDescriptionGenerator.css";
import EnhancedLocationPicker from "../../components/EnhancedLocationPicker/EnhancedLocationPicker";
import ImageUploader from "../../components/Forms/ImageUploader";
import CategorySelector from "../../components/CategorySelector/CategorySelector";
import "./ReportForm.css";
import "../../components/EnhancedLocationPicker/EnhancedLocationPicker.css";
import TextToSpeechButton from "../../components/AIComponents/TextToSpeechButton";
  ...
  const checkForDuplicates = async (reportData) => {
    ...
    try {
      ...
      if (response.data.hasDuplicates) {
        console.log(
          "⚠️ DUPLICATES FOUND! Count:",
          response.data.duplicateCount
        );
