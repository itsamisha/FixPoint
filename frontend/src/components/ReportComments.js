...
import { MessageCircle, Heart, ThumbsUp, Smile, Send, Reply, MoreHorizontal } from "lucide-react";
      ...
      return (
        <div className="reactions-display">
          <div className="reactions-placeholder">
            <span className="reactions-placeholder-text">Be the first to react!</span>
          </div>
        </div>
      );
    }
  ...
  return (
    <div className="comment-item">
      ...
      <div className="comment-main">
        <div className="comment-avatar" style={{ background: `linear-gradient(135deg, ${getAvatarColor(comment.user)})` }}>
            ...
            <div className="action-buttons">
              ...
              {comment.replyCount > 0 && (
                ...
                >
                  ...
                  <div className={`pulse-dot ${showReplies ? 'rotate-180' : ''}`}></div>
                </button>
              )}
            </div>
              ...
              <div className="reply-input-card">
                <form onSubmit={handleAddReply} className="reply-form">
                  <div className="reply-form-row">
                    <div className="reply-avatar" style={{ background: `linear-gradient(135deg, ${getAvatarColor(user)})` }}>
...
const ReplyItem = ({ reply, reportId, onCommentUpdate, onReplyUpdate, getUserInitials, getAvatarColor, getUserName, formatTimeAgo }) => {
  const { user } = useAuth();
  const [showReactions, setShowReactions] = useState(false);
  ...
  const ReactionDisplay = ({ replyData }) => {
    ...
    if (totalReactions === 0) {
      return (
        <div className="reactions-display">
          <div className="reactions-placeholder">
            <span className="reactions-placeholder-text">React to this reply</span>
          </div>
        </div>
      );
    }
  ...
  return (
    <div className="reply-item">
      <div className="comment-main">
        <div className="reply-avatar" style={{ background: `linear-gradient(135deg, ${getAvatarColor(reply.user)})` }}>
          ...
          <div className="comment-form-card">
            ...
            <form onSubmit={handleAddComment} className="comment-form">
              <div className="comment-form-row">
                <div className="comment-avatar" style={{ background: `linear-gradient(135deg, ${getAvatarColor(user)})` }}>
                  {getUserInitials(user)}
                </div>
                <div className="comment-input-container">
                  ...
                  <div className="comment-form-footer">
                    <div className={`character-counter ${commentText.length > 500 ? 'warning' : ''}`}>
                    ...
                    <button
                      type="submit"
                      disabled={loading || !commentText.trim() || commentText.length > 500}
          ...
          {comments.length === 0 ? (
            <div className="empty-state">
              ...
              <p className="empty-state-description">
                Be the first to share your thoughts, insights, or questions about this report. Your voice matters!
              </p>
