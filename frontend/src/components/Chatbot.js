  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        addMessage("I apologize, but I'm having trouble processing your request right now. Please try again or contact support if the issue persists.", true);
      }
    } catch (error) {
      ...
      if (error.message.includes('Authentication')) {
        ...
        errorMessage += "Our AI service is temporarily unavailable. I'll try to help with basic information.";
      } else {
          ...
          <div className="chatbot-header">
            <div className="chatbot-header-info">
              ...
              <div className="chatbot-status">
                ...
                {isOnline ? (aiCapabilities.aiEnabled ? 'Advanced AI Active' : 'Smart Mode') : 'Offline'}
              </div>
            </div>
          ...
          <form className="chatbot-input-form" onSubmit={handleSendMessage}>
            <div className="input-container">
              <textarea
                ...
                placeholder={isOnline ? "Ask me a specific question - I'll give you direct, step-by-step help..." : "Chatbot is offline"}
