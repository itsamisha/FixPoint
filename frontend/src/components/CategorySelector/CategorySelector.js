...
const CategorySelector = ({
  ...
  const analyzeIssue = async () => {
    ...
    setIsAnalyzing(true);
    try {
      const result = await categorizationService.categorizeIssue(
        description,
        imageFile,
        location
      );
        ...
        <div className="header-content">
          ...
          <div className="header-text">
            ...
            <p className="header-subtitle">
              AI-powered analysis for accurate categorization
            </p>
          </div>
        </div>
        <button
        ...
        <div className="ai-analysis-result">
          <div className="analysis-header">
            ...
            <div
              ...
              style={{
                backgroundColor: getConfidenceColor(categorization.confidence),
              }}
            >
          ...
          <div className="suggestions-grid">
            ...
            <div className="suggestion-card category-card">
              ...
              >
                <div
                  ...
                  style={{ color: categorization.category.color }}
                >
            ...
            <div className="suggestion-card priority-card">
              ...
              <div
                ...
                onClick={() =>
                  handlePrioritySelect(categorization.priority.value)
                }
              >
                <div
                  className="suggestion-icon"
                  style={{ color: categorization.priority.color }}
                >
                  {getPriorityIcon(categorization.priority.value)}
                </div>
                <div className="suggestion-details">
                  <div className="suggestion-name capitalize">
                    {categorization.priority.value}
                  </div>
            ...
            .map((category) => (
              <div
                ...
                className={`category-option ${
                  ...
                  categorization?.category?.id === category.id
                    ? "selected"
                    : ""
                }`}
                style={{
          ...
          {["low", "medium", "high", "urgent"].map((priority) => (
            <button
              ...
              className={`priority-option ${
                categorization?.priority.value === priority ||
      ...
      <div className="help-section">
        <div className="help-content">
          ...
          <div className="help-text">
            <strong>Smart Tip:</strong> Our AI analyzes your description, image,
            and location to suggest the most appropriate category and priority.
            You can always override these suggestions manually for complete
            control.
          </div>
        </div>
      </div>
